...
df = pd.read_csv(data_folder / "gut_machine.csv")
X = df.iloc[:, 2:]
y = df["Group"]
...
classifiers = {
    ...
    "SVM": SVC(random_state=42, C=0.9, probability=True, class_weight="balanced"),
...
holdout_results_csv_path = "holdout_model_evaluation_gut_results.csv"
