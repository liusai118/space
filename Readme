...
### Result 1: Parallel Immune Alterations in Ageing and Post-Spaceflight Revealed by Single-Cell Sequencing
...
### Result 2: Associations Between Gut, Oral, and Skin Microbiota and Ageing from Mendelian Randomization Studies
...
### Result 3: Microbial Shifts in Gut, Oral, and Skin During Ageing

- **Species Annotation**:
  - `taxonmy_prepare.R`: Used to prepare the species annotation information table for basic analysis.

### Result 4: Spaceflight-Induced Microbial Alterations Across Multiple Body Sites

- **Species Annotation**:
  - `taxonmy_prepare.R`: Used to prepare the species annotation information table for basic analysis.

### Result 5: Modulation of Ageing-Associated Microbiota by Spaceflight and Potential Protective Strategies
...
### Result 6: Metatranscriptomic Insights into Functional Changes of Ageing-Associated Microbiota Post-Spaceflight
