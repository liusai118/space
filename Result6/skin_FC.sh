...
cat index.txt | while read type
do
     featureCounts -T 10 -a /home/liusai/24/space/tempindex/skin/${type}/${type}.gtf -o ${type}read.count -p -t exon -g gene_id  $output/FC/${type}/*.bam
done
